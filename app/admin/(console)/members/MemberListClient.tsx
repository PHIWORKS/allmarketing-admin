...
export default function MemberListClient() {
  ...
  const fromQS = useMemo(() => new URLSearchParams(sp.toString()).toString(), [sp]);
        ...
        <table className="min-w-full text-sm">
          ...
          <tbody>
            ...
            {!loading && data.rows.map((r) => {
              const editHref = `/admin/members/${encodeURIComponent(r.id)}/edit${fromQS ? `?from=${encodeURIComponent(fromQS)}` : ""}`;
              return (
